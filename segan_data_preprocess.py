...
clean_train_folder = 'Datasets/clean_train'
noisy_train_folder = 'Datasets/noisy_train'
clean_test_folder = 'Datasets/clean_valid'
noisy_test_folder = 'Datasets/noisy_valid'
serialized_train_folder = 'Datasets/serialized_train_data'
serialized_test_folder = 'Datasets/serialized_valid_data'
window_size = 2 ** 14  #2 ** 14 about 2 second of samples at 8 kHz
...
def process_and_serialize(data_type):
    ...
    for root, dirs, files in os.walk(clean_folder):
        ...
        for filename in tqdm(files, desc='Serialize and down-sample {} audios'.format(data_type)):
            ...
            _, clean_sliced = slice_signal(clean_file, window_size, stride, sample_rate)
            _, noisy_sliced = slice_signal(noisy_file, window_size, stride, sample_rate)
